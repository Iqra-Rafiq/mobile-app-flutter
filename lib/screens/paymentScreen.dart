                                      ...
                                      children: [
                                        ...
                                        Padding(
                                          ...
                                          child: CustomTextInput(
                                              hintText: "card Number",obscureText: false, controller: cardNumber,),
                                        ...
                                        Padding(
                                          padding: const EdgeInsets.symmetric(
                                              horizontal: 20.0),
                                          child: CustomTextInput(
                                              hintText: "Security Code",obscureText: true,controller: securityCode,),
                                        ),
                                        SizedBox(
                                          height: 20,
                                        ),
                                        Padding(
                                          padding: const EdgeInsets.symmetric(
                                              horizontal: 20.0),
                                          child: CustomTextInput(
                                              hintText: "First Name",obscureText: false, controller: firstName,),
                                        ),
                                        SizedBox(
                                          height: 20,
                                        ),
                                        Padding(
                                          padding: const EdgeInsets.symmetric(
                                              horizontal: 20.0),
                                          child: CustomTextInput(
                                              hintText: "Last Name",obscureText: false, controller: lastName,),
                                        ),
                                        SizedBox(
                                          height: 20,
                                        ),
